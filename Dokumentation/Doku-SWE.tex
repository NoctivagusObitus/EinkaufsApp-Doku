...
%\begin{itemize}
%\item[1.]Ionic Framework: \href{http://ionicframework.com/}
%\item[2.]Ionic Framework
%\item[3.]Ionic Getting Started: \href{http://ionicframework.com/getting-started/}
%\item[4.]ngCordova - Plugin Seite \href{http://ngcordova.com/}
%\item[5.]BarCode Scanner : Plugin \href{hhttp://ngcordova.com/docs/plugins/barcodeScanner/}
%\item[6.]Beispiel Projekt: \href{https://github.com/bastisk/suedm}
%\item[7.]Editor: \href{http://brackets.io/}
%\item[8.]Angular JS-Kurs: \href{https://www.codeschool.com/courses/shaping-up-with-angular-js/}
%\item[9.]Tutorial zum Routing: \href{https://scotch.io/tutorials/angular-routing-using-ui-router}
%\item[10.]App-Projekt: \href{http://www.mobile2b.de/ablauf-app-projekt/}
%\item[11.] Dokumentationshilfe: \href{http://www.tellsbells.de/dokuwebsite/tbdokumentation.pdf}
%\item[12.] Dokumentationshilfe: \href{https://www.lecturio.de/magazin/projekte-dokumentieren/}
%\item[13.] Open Source mit API über eine einfachen HTTP-GET-Reguest: \href{http://www.opengtindb.org/api.php}
%\item[14.] Suchmaschine der Firma die GTIN-Nummern verwaltet: \href{http://www.gepir.de/v31/V31_client/gtin.aspx}
%\end{itemize}
\newpage
\section*{Anhang}
\newpage
