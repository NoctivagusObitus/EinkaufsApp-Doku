...
% Hier dann ein einleitender Satz und der Rest Stichpunktartig?
\begin{itemize}
...
\addcontentsline{toc}{subsubsection}{Ideen: Out of Focus }
\begin{itemize}
...
%Idee Annika: Das wird dann noch in Sätze geschrieben!
% Idee Huong:Gute Idee. Am besten dann aber aufgeteilt in "ToDo, Umsetzung, Probleme etc.pp" einfach ne idee :) vielleicht fällt dir was besseres ein
\subsection{Designer}
